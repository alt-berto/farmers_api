...
$router->group( [ 'middleware' => 'jwt', 'prefix' => 'api' ], function(  ) use ( $router ) {
    ...
    /*--- User Code Begin ---*/
    $router->get( '/user/codes', 'UserCodeController@index' );
    $router->get( '/user/codes/list', 'UserCodeController@list' );
    $router->post( '/user/codes/search', 'UserCodeController@search' );
    $router->post( '/user/codes', 'UserCodeController@store' );
    $router->get( '/user/codes/{key}', 'UserCodeController@show' );
    $router->put( '/user/codes/{id}', 'UserCodeController@update' );
    $router->patch( '/user/codes/{id}', 'UserCodeController@update' );
    $router->delete( '/user/codes/{id}', 'UserCodeController@destroy' );
    /*--- USer Code End ---*/
    ...
    $router->get( '/points/generator/sku/{sku}/value/{value}/quantity/{quantity}', 'PointController@pdf_generator' );
    ...
    /*--- Redeemable Products Begin ---*/
    $router->get( '/redeemable/products', 'RedeemableProductController@index' );
    $router->get( '/redeemable/products/list', 'RedeemableProductController@list' );
    $router->post( '/redeemable/products/search', 'RedeemableProductController@search' );
    $router->post( '/redeemable/products', 'RedeemableProductController@store' );
    $router->get( '/redeemable/products/{sku}', 'RedeemableProductController@show' );
    $router->put( '/redeemable/products/{id}', 'RedeemableProductController@update' );
    $router->patch( '/redeemable/products/{id}', 'RedeemableProductController@update' );
    $router->delete( '/redeemable/products/{id}', 'RedeemableProductController@destroy' );
    /*--- Redeemable Products End ---*/
