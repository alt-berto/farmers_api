                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        @foreach($order->details as $item)
                                                            <li>
                                                                {{ $item->inventory_price->inventory->name . ' - Precio: ' . ($item->real_price * $item->quantity) }}
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                <span class="apple-link">UPL Farmers, Condominio Industrial Flexipark, 1er edificio, Alajuela - Costa Rica</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="content-block powered-by">
                                Powered by <a href="https://www.piso83digital.com/">Piso83 Digital</a>.
                            </td>
                        </tr>
                    </table>
                </div>
